...
namespace SachOnline.Areas.Admin.Controllers
{
    public class SachController : Controller
    {
        ...
        public ActionResult Create(SACH sach, FormCollection f, HttpPostedFileBase fFileUpload)
        {
            ...
            ViewBag. MaCD = new SelectList(db.CHUDEs.ToList().OrderBy(n => n.TenChuDe), "MaCD", "TenChuDe");
            ViewBag.NaNXB = new SelectList(db.NHAXUATBANs.ToList().OrderBy(n => n.TenNXB), "MaNXB", "TenNXB");
            if(fFileUpload == null)
            {
        ...
        public ActionResult DeleteConfirm(int id, FormCollection f)
        {
            ...
            if (ctdh.Count() > 0)
            {
                ...
                ViewBag.ThongBao = "Sách này đang có trong bảng Chỉ tiết đặt hàng <br>" + "Nếu muốn xóa thì phải xóa hết mã sách này trong bàng Chi tiết đặt hàng";
                return View(sach);
            }
